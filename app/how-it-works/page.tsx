          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="p-6">
                <Shield className="h-12 w-12 text-be-accent mb-4" />
            ...
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="p-6">
                <FileCheck className="h-12 w-12 text-be-accent mb-4" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="bg-gray-800/50 border-gray-700">
                <CardContent className="p-6">
                  <step.icon className="h-12 w-12 text-be-accent mb-4" />
              ...
              <CardContent className="p-6">
                ...
                <ul className="space-y-3 text-gray-400">
                  <li className="flex items-center">
                    <Coins className="h-5 w-5 text-be-accent mr-2" />
                    Low minimum investment threshold
                  </li>
                  <li className="flex items-center">
                    <Shield className="h-5 w-5 text-be-accent mr-2" />
                    Direct property ownership rights
                  </li>
                  <li className="flex items-center">
                    <Building2 className="h-5 w-5 text-be-accent mr-2" />
            ...
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="p-6">
                ...
                <ul className="space-y-3 text-gray-400">
                  ...
                  <li className="flex items-center">
                    <Users className="h-5 w-5 text-be-accent mr-2" />
